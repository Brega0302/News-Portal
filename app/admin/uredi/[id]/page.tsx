...
import { isAdminAuthenticated, saveArticle, getStoredArticles } from "@/lib/admin-utils"
...
export default function EditArticlePage({ params }: EditArticlePageProps) {
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      content: foundArticle.content.replace(/<br>/g, "\n"),
      imageUrl: foundArticle.imageUrl,
      categoryId: foundArticle.category.id,
  ...
  if (!article) {
    return <div className="min-h-screen bg-gray-100 flex items-center justify-center">Članak nije pronađen</div>
  }
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="max-w-4xl mx-auto">
          <CardHeader>
            <CardTitle className="text-2xl">Uredi članak</CardTitle>
          </CardHeader>
          <CardContent>
